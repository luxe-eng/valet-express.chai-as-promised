(function () {
            ...
            var derivedPromise = getBasePromise(that).then(
                ...
                function (reason) {
                    ...
                    if (typeof reason === "object") {
                        that.assert(compare(message, reason),
                                    "expected promise to be rejected with an error containing #{exp} in #{act}",
                                    "expected promise not to be rejected with an error containing #{exp}",
                                    message,
                                    reason);
                    }
    ...
    // Taken from chai-subset: https://github.com/debitoor/chai-subset/blob/fe09bc8f2e98ac146bcd30402d73c050319b4a59/lib/chai-subset.js#L24
